       ...
       <section className="py-16 bg-gray-50">
          <div className="wrapper">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-fuchsia-400 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-indigo-400 rounded-full flex items-center justify-center mx-auto mb-4">
